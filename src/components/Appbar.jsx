    ...
    const renderMobileMenu = (
        ...
        >
          ...
          <MenuItem onClick={handleProfileMenuOpen}>
            ...
            <Link to= {user === "" ? "/login": "/"} style={{textDecoration: "none", color: "black"}}><p>Profile</p></Link>
          </MenuItem>
        </Menu>
      );
        ...
        <Box sx={{ flexGrow: 1 }}>
          <AppBar position="fixed">
            <Toolbar>
              ...
              >
                <Link to="/" style={{textDecoration: "none", color: "white"}}>Project X </Link>
              </Typography>
              <Search>
                <SearchIconWrapper>
                  <SearchIcon />
              ...
              <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                ...
                <IconButton
                  ...
                  color="inherit"
                >
                  <Link to= {user === "" ? "/login": "/"} style={{textDecoration: "none", color: "white"}}><AccountCircle /></Link>
                </IconButton>
              </Box>
